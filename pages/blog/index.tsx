...
const Blog: NextPage<BlogProps> = ({ pages }) => {
  return (
    <Container maxWidth={1200}>
      <Head>
        <title>Blog - TJ Pavaritpong</title>
        <meta property="og:title" content="Blog – TJ Pavaritpong" />
      </Head>
      <Container mb="3rem">
        <Title>Blog</Title>
        <Text textAlign="center">
          Everything from fictional short stories and poems to useful articles about software engineering and various other things.
        </Text>
      </Container>
